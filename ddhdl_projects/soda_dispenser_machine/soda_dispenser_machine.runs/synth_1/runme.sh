...
HD_PWD='D:/vivado_project/ddhdl_projects/soda_dispenser_machine/soda_dispenser_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soda_dispense_machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soda_dispense_machine.tcl
