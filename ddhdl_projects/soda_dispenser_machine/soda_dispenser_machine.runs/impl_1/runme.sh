...
HD_PWD='D:/vivado_project/ddhdl_projects/soda_dispenser_machine/soda_dispenser_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soda_dispense_machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soda_dispense_machine.tcl -notrace
