...
HD_PWD='D:/vivado_project/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log newmod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source newmod.tcl
