...
HD_PWD='D:/vivado_project/sample_boolean/sample_boolean.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sample_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sample_adder.tcl -notrace
