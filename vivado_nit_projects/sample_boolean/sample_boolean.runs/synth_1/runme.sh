...
HD_PWD='D:/vivado_project/sample_boolean/sample_boolean.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sample_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sample_adder.tcl
