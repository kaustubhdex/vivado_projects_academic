...
HD_PWD='D:/vivado_project/all_gates/all_gates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log all_gates_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source all_gates_top.tcl
