...
HD_PWD='D:/vivado_project/decoder_2to4/decoder_2to4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_2to4_df.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_2to4_df.tcl
