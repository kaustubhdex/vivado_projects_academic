...
HD_PWD='D:/vivado_project/vivado_nit_projects/decoder_4to16/decoder_4to16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_4to16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_4to16.tcl -notrace
