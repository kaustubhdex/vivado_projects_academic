...
HD_PWD='D:/vivado_project/practice_1/practice_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit4_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit4_adder.tcl
