...
HD_PWD='D:/vivado_project/nbit_adder/nbit_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nbit_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nbit_adder.tcl
