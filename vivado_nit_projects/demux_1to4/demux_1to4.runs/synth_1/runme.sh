...
HD_PWD='D:/vivado_project/demux_1to4/demux_1to4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux_1to4_df.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux_1to4_df.tcl
