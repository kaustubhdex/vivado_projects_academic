...
HD_PWD='D:/vivado_project/vivado_nit_projects/nbit_comparator/nbit_comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nbit_comparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nbit_comparator.tcl
