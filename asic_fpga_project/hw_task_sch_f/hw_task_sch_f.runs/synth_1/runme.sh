...
HD_PWD='D:/vivado_project/asic_fpga_project/hw_task_sch_f/hw_task_sch_f.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_task_sch_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_task_sch_top.tcl
