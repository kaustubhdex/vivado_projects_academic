...
HD_PWD='D:/vivado_project/asic_fpga_project/hw_task_sch_f/hw_task_sch_f.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_task_sch_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw_task_sch_top.tcl -notrace
